async function run() {
  ...
  console.log("Checkout with Bearer:", JSON.stringify(checkoutJson, null, 2));

  checkoutRes = await fetch('https://admin.dffotoshop.com.ng/wp/graphql', {
    method: 'POST',
    headers: { 
      'Content-Type': 'application/json',
  ...
  console.log("Checkout without Bearer:", JSON.stringify(checkoutJson, null, 2));
}
run();
